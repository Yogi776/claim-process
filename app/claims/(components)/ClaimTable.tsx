            ...
            <React.Fragment key={i}>
              <tr key={i}
                ...
                <td className="flex justify-center">
                  {claimItem.dataOS.confidence > 83 ?
                    claimItem.dataOS.suggest === "Accept" ?
                    ...
                    <span className=" italic">Reject</span>
                  }
                </td>
                <td className=" text-center"> {Math.round(claimItem.dataOS.confidence)} </td>
                <td className=" text-center"> {Math.round(claimItem.dataOS.confidence * (1 - (Math.random() * 0.03 + 0.05)))} </td>
